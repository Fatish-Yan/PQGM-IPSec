...
| gmalg_signer | SM2 Sign | ✅ 编译完成 | ⏳ 待测试 | 签名/验证 |

### 6.2 待实现 ⏳

| 优先级 | 模块 | 算法 | 说明 |
|--------|------|------|------|
| **高** | gmalg_ke | SM2-KEM | 双向封装密钥交换 (Transform ID 60001) |
| **中** | gmalg_crypter | SM4 CTR | 计数器模式 |
| **高** | - | ML-KEM 集成 | 利用 strongSwan 6.0 ml 插件 |
| **高** | - | IKE_INTERMEDIATE | 实现中间交换流程 |
| **中** | - | 双证书分发 | Certificate payload 处理 |
...
| 模式 | 加密 | 解密 |
|------|------|------|
| ECB | 189.45 MB/s | 189.94 MB/s |
| CBC | 161.27 MB/s | 174.76 MB/s |
